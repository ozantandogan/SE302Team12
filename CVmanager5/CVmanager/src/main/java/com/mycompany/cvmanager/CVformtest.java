...
public class CVformtest extends javax.swing.JFrame {
    ...
    public void Connect(){
        ...
        try {
            ...
            con = DriverManager.getConnection("jdbc:derby:D:/Derby2/cv4;create=true");
            System.out.println("connected to the database");
            /*pst = con.prepareStatement("CREATE TABLE CVF ( ID INT NOT NULL PRIMARY KEY GENERATED ALWAYS AS IDENTITY, NAME VARCHAR(255), SURNAME VARCHAR(255), AGE VARCHAR(255), DEPARTMENT VARCHAR(255), NOTES VARCHAR(100)");
            pst.executeQuery();*/
            /*Statement stmt = con.createStatement();
            String query = "CREATE TABLE CVF("
    ...
    private void btnPDFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPDFActionPerformed
        try {
            ...
            PdfWriter.getInstance(PDFreport, new FileOutputStream("D:\\CVoutput.pdf"));
